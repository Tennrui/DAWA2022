            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class=" navbar-nav nav nav-pills sm-3 " id="pills-tab" >
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <a class="dropdown-item active" href="../Ventas/VenderPiezasAsesor.php">Venta Piezas</a>
                        <a class="dropdown-item" href="../Ventas/VenderVehiculosAsesor.php">Venta Vehiculos</a>
                        </ul>
                    </li>
                    <li class="nav-item"> <a class="nav-link" href="../VistaForm/Facturas _Asesor.html">Facturar</a> </li>
